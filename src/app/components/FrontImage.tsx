...
export default function FrontImage() {
    return (
        <>
            <div className="text-stone  bg-scroll opacity-75 w-fit leading-8 min-w-80  text-left hover:capitalize rounded-lg">
                <div className='pl-14 content-around place-content-between min-w-48 md:h-full md:w-auto pr-24'>
                    <header>
                        <h1 className='bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 via-violet-400 to-lime-500 text-4xl p-10 line-clamp-none hover:text-6xl text-center text-slate'>Welcome To Big Easy Events!</h1>
                    </header>
