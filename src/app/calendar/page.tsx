                      ...
                      <div className="hidden w-full lg:grid lg:grid-cols-7 lg:grid-rows-6 lg:gap-px">
                          ...
                          <div className="relative bg-white px-3 py-2">
                              ...
                              <ol className="mt-2">
                                  <li>
                                      <a href="#" className="group flex">
                                          <p className="flex-auto truncate font-medium text-gray-900 group-hover:text-indigo-600">Jazz Day</p>
                          ...
                          <div className="relative bg-white px-3 py-2">
                              ...
                              <ol className="mt-2">
                                  <li>
                                      <a href="#" className="group flex">
                                          <p className="flex-auto truncate font-medium text-gray-900 group-hover:text-indigo-600">French Quarter Festival</p>
                          ...
                          <div className="relative bg-white px-3 py-2">
                              ...
                              <ol className="mt-2">
                                  <li>
                                      <a href="#" className="group flex">
                                          <p className="flex-auto truncate font-medium text-gray-900 group-hover:text-indigo-600">World War II Museum</p>
                                  ...
                                  <li>
                                      <a href="#" className="group flex">
                                          <p className="flex-auto truncate font-medium text-gray-900 group-hover:text-indigo-600">Saints game</p>
                          ...
                          <div className="relative bg-gray-50 px-3 py-2 text-gray-500">
                              ...
                              <ol className="mt-2">
                                  <li>
                                      <a href="#" className="group flex">
                                          <p className="flex-auto truncate font-medium text-gray-900 group-hover:text-indigo-600">Burbon Street bar night with friends</p>
